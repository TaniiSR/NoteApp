...
object DataDependencies {
    //Converter JSON to GSON Data objects 
    const val GSON = "com.google.code.gson:gson:${DataVersions.GSON}"

    const val ROOM_RUNTIME = "androidx.room:room-runtime:${DataVersions.ROOM}"
    const val ROOM_COMPILER = "androidx.room:room-compiler:${DataVersions.ROOM}"
    const val ROOM_KTX = "androidx.room:room-ktx:${DataVersions.ROOM}"

    // optional - Test helpers
    const val ROOM_TEST = "androidx.room:room-testing:${DataVersions.ROOM}"

    //Glide Image Loading
    const val GLIDE = "com.github.bumptech.glide:glide:${DataVersions.GLIDE}"
    const val GLIDE_COMPILER = "com.github.bumptech.glide:compiler:${DataVersions.GLIDE}"
